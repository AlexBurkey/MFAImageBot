...
HELP_TEXT = ("Usage: I respond to comments starting with `!MFAImageBot` (case insensitive).  \n"
             "`!MFAImageBot help`: Print this help message.  \n"
             "`!MFAImageBot <album-link> 2, 3, 42`: I attempt to directly link the 2nd, 3rd, and 42nd images from <album-link>  \n"
             "`!MFAImageBot 2, 3, 42`: I attempt to directly link the 2nd, 3rd, and 42nd images from the album in the submission  \n"
